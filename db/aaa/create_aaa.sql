...
CREATE TABLESPACE "AFM_P1" DATAFILE '/opt/oracle/oradata/aaa/AFM_P1.dbf' SIZE 1024M REUSE DEFAULT STORAGE (INITIAL 10240 NEXT 10240 MINEXTENTS 1 MAXEXTENTS 256 PCTINCREASE 8) ONLINE;
-- CREATE TABLESPACE "AFM_P1" DATAFILE 'C:\oracle\product\10.2.0\oradata\aaa\AFM_P1.ora' SIZE 2000M REUSE DEFAULT STORAGE (INITIAL 100240 NEXT 100240 MINEXTENTS 1 MAXEXTENTS 256 PCTINCREASE 0) ONLINE;
...
CREATE TABLESPACE "AFMDOCMGMT_BLOB" LOGGING DATAFILE '/opt/oracle/oradata/aaa/AFMDOCMGMT_BLOB.dbf' SIZE 1024M EXTENT MANAGEMENT LOCAL ONLINE;
-- CREATE TABLESPACE "AFMDOCMGMT_BLOB" LOGGING DATAFILE 'C:\oracle\product\10.2.0\oradata\aaa\AFMDOCMGMT_BLOB.ora' SIZE 100M EXTENT MANAGEMENT LOCAL ONLINE;
